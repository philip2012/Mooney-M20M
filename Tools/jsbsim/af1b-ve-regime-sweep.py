...
print(
    "MOONEY AF1B VE REGIME CHARACTERIZATION SWEEP"
)
print(
    "============================================"
)
...
with tempfile.TemporaryDirectory() as tmp:
    ...
    for altitude_ft in ALTITUDES_FT:
        ...
        print(
            "Pilot   FFcap   MAPnat  MAPve   dMAP   "
            "HPnat   HPve    dHP    VEnat   VEve"
        )
...
print(
    "The Stage-2E throttle controller remains disabled throughout."
)
print(
