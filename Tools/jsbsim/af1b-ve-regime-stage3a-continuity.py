...
# Fine Stage-3A continuity characterization.
# 0.50 through 1.00 in 0.02 pilot-throttle increments.
PILOT_THROTTLES = tuple(
    round(
        0.50 + 0.02 * index,
        2,
    )
...
print(
    "MOONEY AF1B STAGE-3A VE CONTINUITY SWEEP"
)
print(
    "============================================"
)
