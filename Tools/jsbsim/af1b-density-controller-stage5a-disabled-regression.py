    ...
    for step in range(steps):
        ...
        if not fdm.run():
            raise RuntimeError(
                ...
                "Stage-5A disabled-regression transient"
            )
...
print(
    ...
    "STAGE-5A DISABLED-REGRESSION DYNAMIC XML TEST"
)
print(
    "=============================================="
)
...
# ==============================================================
# Stage-5A disabled-regression edge qualification
# ==============================================================
...
if all_pass:
    print(
        ...
        "STAGE-5A DISABLED-REGRESSION DYNAMIC XML TEST PASS"
    )
else:
    raise SystemExit(
        "AF1B DENSITY CONTROLLER "
        "STAGE-5A DISABLED-REGRESSION DYNAMIC XML TEST FAIL"
    )
