    ...
    for step in range(steps):
        ...
        if not fdm.run():
            raise RuntimeError(
                ...
                "production-candidate transient"
            )
...
print(
    ...
    "PRODUCTION-CANDIDATE DYNAMIC XML TEST"
)
print(
    "=============================================="
)
...
if all_pass:
    print(
        ...
        "PRODUCTION-CANDIDATE DYNAMIC XML TEST PASS"
    )
else:
    print(
        "AF1B DENSITY CONTROLLER "
        "PRODUCTION-CANDIDATE DYNAMIC XML TEST FAIL"
    )
    raise SystemExit(1)
