...
SYSTEM_XML = (
    ...
    / "Tools"
    / "jsbsim"
    / "af1b-density-controller-stage2c.xml"
)
...
def prepare_test_tree(root):
    ...
    new = (
        old
        + '    <system '
        'file="af1b-density-controller-stage2c" />\n'
    )
...
if all_pass:
    print(
        ...
        "STAGE-2C DYNAMIC XML TEST PASS"
    )
else:
    raise SystemExit(
        "AF1B DENSITY CONTROLLER "
        "STAGE-2C DYNAMIC XML TEST FAIL"
    )
