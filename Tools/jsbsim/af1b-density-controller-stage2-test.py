...
SYSTEM_XML = (
    ...
    / "Tools"
    / "jsbsim"
    / "af1b-density-controller-stage2.xml"
)
...
def prepare_test_tree(root):
    ...
    new = (
        old
        + '    <system '
        'file="af1b-density-controller-stage2" />\n'
    )
...
if all_pass:
    print(
        ...
        "STAGE-2 DYNAMIC XML TEST PASS"
    )
else:
    raise SystemExit(
        "AF1B DENSITY CONTROLLER "
        "STAGE-2 DYNAMIC XML TEST FAIL"
    )
