...
def make_fdm(test_root, altitude_ft):
    ...
    # JSBSim atmosphere/delta-T is a Rankine temperature
    # difference; Fahrenheit and Rankine degree increments have
    # identical magnitude.
    fdm.set_property_value(
        "atmosphere/delta-T",
        TEMP_BIAS_F,
...
print("MOONEY AF1B DENSITY/POWER CROSS-TEMP SWEEP")
print("============================================")
