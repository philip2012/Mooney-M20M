...
SYSTEM_XML = (
    ...
    / "Tools"
    / "jsbsim"
    / "af1b-density-controller-stage4a.xml"
)
...
def prepare_test_tree(root):
    ...
    new = (
        old
        + '    <system '
        'file="af1b-density-controller-stage4a" />\n'
    )
...
print(
    "MOONEY AF1B STAGE-4A "
    "LYCOMING 2575-RPM ENVELOPE VALIDATION"
)
print(
    "============================================"
)
...
print()
print(
    " Alt  CPfac    RPM    Blade    MAP    Ref    Delta"
    "      HP     Cap"
)
print(
    "-------------------------------------------------------------"
...
print(
    "Below the turbo capability boundary, Stage 3A may command "
